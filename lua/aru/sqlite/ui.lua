---@module "aru.sqlite.ui"
---Scratchpad tab, windows, and buffer lifecycle.

local M = {}

---@class aru.sqlite.SqlPreview
---@field buf integer
---@field win integer
...
---@field sql_preview aru.sqlite.SqlPreview|nil
...
local function tab_label(tabpage)
    local label = vim.t[tabpage].aru_tab_label
...
function M.open(db_path, on_lost)
    ...
    vim.t[tabpage].aru_tab_label = "SQLite: " .. vim.fs.basename(db_path)
    vim.o.tabline = "%!v:lua.require'aru.sqlite.ui'.tabline()"
