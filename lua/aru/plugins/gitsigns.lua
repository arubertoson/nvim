...
require("gitsigns").setup({
    on_attach = function(bufnr)
        ...
        vim.keymap.set("n", "]c", function() gs.nav_hunk("next", nav_opts) end, key_opts)
        vim.keymap.set("n", "[c", function() gs.nav_hunk("prev", nav_opts) end, key_opts)
        ...
        vim.keymap.set("n", "<leader>tb", gs.toggle_current_line_blame, key_opts)
    end,
})
