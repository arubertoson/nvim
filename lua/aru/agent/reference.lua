...
---@alias aru.agent.reference.Selector aru.agent.reference.LineSelector|aru.agent.reference.SymbolSelector
...
---@param body string
---@return string|nil, aru.agent.reference.Selector|nil, boolean, boolean, string|nil
...
---@param span aru.agent.reference.Span
...
---@param out aru.agent.reference.Reference[]
...
---@return aru.agent.reference.Reference|nil
