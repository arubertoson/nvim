...
---@class aru.agent.Session
---@field id string
---@field cwd string
---@field responses aru.agent.Response[]
---@field response_index integer

---@class aru.agent.Response
---@field lines string[]
---@field label string
---@field status "streaming"|"complete"|"error"

---@class aru.agent.SessionHistory
---@field sessions aru.agent.Session[]
---@field session_index integer

---@class aru.agent.session.InactiveState
---@field kind "inactive"

---@class aru.agent.session.ActiveState
---@field kind "active"
---@field history aru.agent.SessionHistory

---@alias aru.agent.session.State aru.agent.session.InactiveState|aru.agent.session.ActiveState

---@class aru.agent.session.Selection
---@field session aru.agent.Session
...
---@return aru.agent.SessionHistory|nil
local function history()
    if _state.kind == "inactive" then return nil end
    return _state.history
end

---@return aru.agent.Response|nil
...
---@param cwd string
---@param label string
---@return aru.agent.Session
---@return aru.agent.Response
...
---@param response aru.agent.Response
...
---@return aru.agent.session.Selection|nil
